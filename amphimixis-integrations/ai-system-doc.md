...
A system of agents and tools implements [this methodology](../docs/migration_readiness_methodology.md). These agents must be regenerated by AI after a methodology update to stay in sync. They are **generated artifacts**; service agents exist for this purpose. The tools must be written by a human, AI can only suggest changes to the toolset.

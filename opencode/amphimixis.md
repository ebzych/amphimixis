...
2) Use amphimixis.build tool to build project if building inststructions is simple (configuration and then running building) or build from sources by instruction from README or other documentation.
3) Use amphimixis.profile tool to profile project. Output of these utilities print to user in pretty format.

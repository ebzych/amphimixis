...
TODO:
1) Analyze project repository: use @amphimixis.analyze tool. Clearly tell about the seriousness, complexity, maintainability and portability of the project based on these data.

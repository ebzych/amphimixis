...
2. **IMPORTANT STEP**: **Use the `amphimixis-profile` tool** to profile the project.
...
3. **CALL THE `amphimixis-profile` TOOL** with the project path and optional `build_name`.

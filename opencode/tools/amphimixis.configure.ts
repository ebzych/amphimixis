...
export default tool({
  ...
  args: {
    configFilePath: tool.schema
      ...
      .optional()
      .describe(
        "Path where to save the configuration file (default: input.yml in current directory)",
      ),
      ...
      .array(
        tool.schema.object({
          ...
          address: tool.schema
            ...
            .optional()
            .describe(
              "Address of platform in network (if address is not specified, leave blank)",
            ),
